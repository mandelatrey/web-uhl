...
const Blog = () => {
  ...
  return (
    <section className="w-full min-h-screen py-16 px-4 mb-15">
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="grid grid-cols-1 gap-4 md:gap-6 lg:h-[600px] content-between justify-items-center">
            {regularPosts.map((post) => (
              <div 
                key={post.id}
                className="flex flex-col items-center justify-center sm:flex-row gap-3 md:gap-4 bg-highlight-green hover:bg-highlight-green/60 rounded-2xl overflow-hidden border border-gray-200 hover:shadow-md transition-all duration-300 ease-in cursor-pointer group h-full"
              >
