...
const Pillars = () => {
  ...
  return (
    <section data-navbar-invert="true" className='w-full min-h-dvh overflow-hidden flex items-center justify-center py-6 md:py-16 lg:py-20 -pt-15 mb-5' ref={container}>
